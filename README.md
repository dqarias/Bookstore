...
> "Bookstore" is a website built with React and Redux. It is a Single Page App (SPA) that allows users to:
...
This project is [MIT](https://github.com/dqarias/bookstore/blob/development/LICENSE) licensed.